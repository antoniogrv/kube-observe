...
Per sfruttare l'ELK Stack come SOAR, invece, è possibile integrare l'automazione delle risposte agli incidenti (cioè l'engine SOAR in sé) direttamente nel flusso di lavoro di Elasticsearch e Kibana. Ad esempio, è possibile configurare avvisi basati su criteri predefiniti per rilevare automaticamente le minacce e avviare risposte programmate, come l'isolamento di dispositivi compromessi, il blocco di indirizzi IP sospetti o l'avvio di investigazioni dettagliate. Utilizzando gli strumenti di visualizzazione di Kibana, gli operatori possono monitorare le azioni automatizzate e ottenere una panoramica completa delle operazioni di risposta agli incidenti. 
...
\begin{center}
    \includegraphics[width=6.5in]{images/kube-elastic.png}
\end{center}
