...
Questo documento, intitolato \textbf{Kubernetes Observability \& Detection Engineering}, ha l'obiettivo di illustrare un lavoro progettuale di natura parzialmente compilativa e con una limitata componente pratica, descrivendo in maniera esaustiva e organica l'analisi svolta nel contesto in esame, e mostrando in maniera dettagliata e rigorosa i procedimenti svolti per ottenere l'applicativo realizzato.
